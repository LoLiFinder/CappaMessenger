...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<MessagesGroup> mChatList;
    public static final int SENDER = 0;
    public static final int RECIPIENT = 1;

    public MessageAdapter(List<MessagesGroup> listOfFireChats) {
    ...
    private void configureSenderView(ViewHolderSender viewHolderSender, int position) {
        MessagesGroup senderFireMessage= mChatList.get(position);
    ...
    private void configureRecipientView(ViewHolderRecipient viewHolderRecipient, int position) {
        MessagesGroup recipientFireMessage = mChatList.get(position);
    ...
    public void refillAdapter(MessagesGroup newFireChatMessage){
